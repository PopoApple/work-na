<template>
  <div>
    <div class="box_1_title">
      ...
      <nuxt-link
        class="box_1_link"
        key="/merchantDetail/_id/goods"
        :to="{
            name: 'material-merchant-merchantDetail-id-goods',
            params:{id:id}
          }"
      >商品</nuxt-link>
      <div class="box_1_link_choose">职位</div>
      <nuxt-link
        class="box_1_link"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      merchantId() {
        return this.$nuxt.$route.params.merchantId
      }
    }
  }
</script>
