<template>
  ...
  >-->
  <div class="magnifier-box" :class="vertical?'vertical':''" :ref="id">
    <!-- <img v-show="showImg" :src="imgUrl" alt crossorigin="anonymous" /> -->
    <!-- <img v-show="showImg" :src="imgUrl" alt /> -->
    <CcImage v-show="showImg" :src="imgUrl" sizeLevel="l"></CcImage>
    ...
    methods: {
      ...
      initBox() {
        ...
        this.img.onload = () => {
          ...
          setTimeout(() => {
            ;(this.rectTimesX =
              this.imgbox.offsetWidth / this.scale / box.querySelector('img').offsetWidth),
              (this.rectTimesY =
                this.imgbox.offsetHeight / this.scale / box.querySelector('img').offsetHeight)
          }, 20)
        }
      },
      mousemove(e) {
